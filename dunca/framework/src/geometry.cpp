...
const GLenum Geometry::GeometryParameters::attribsCount[AttribOrder_Count] = {3, 2, 3};
const unsigned char Geometry::GeometryParameters::defaultTypeSize = sizeof(GLfloat);
    ...
    GeometryParamsExt* ext/*=nullptr*/) throw()
{
    ...
    {
        throw std::runtime_error("Object::setup: Bad parameters");
    }
    // Setup EBO if needed
    if(p.indices != NULL)
    {
