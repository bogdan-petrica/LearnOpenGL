...
int main()
{
    try {
        ...
        window = glfwCreateWindow(800, 600, "Camera", NULL, NULL);
        ...
        program.LoadVertexShader("LearnOpenGL/Camera/Camera.vs");
        program.LoadFragmentShader("LearnOpenGL/Camera/Camera.frag");

        LGL::Texture texture1;
        texture1.Load("LearnOpenGL/Camera/container.jpg");
        ...
        texture2.Load("LearnOpenGL/Camera/awesomeface.png");
